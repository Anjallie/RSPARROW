...
# SPARROW URL:  https://urldefense.com/v3/__http://water.usgs.gov/nawqa/sparrow/__;!!PhOWcWs!1xoyMCQvn7zHf7yo5lhh__fjhjEqmmyq4tL3xUuBv85mvRJP-LxyHYMg2_NTynY688JB3uKiMNWUJe1eHydblq8PmA$ 
 ...
 # window in RStudio (located next to the "Run" button). 
  ...
  ################################
   ...
   input_data_fileName <- "data1_9_22.csv"
  ...
  class_landuse<-NA   # for NA, total drainage area is used as the default classification variable
   class_landuse <- c("forest","crops","pasture","urban","wetlands")
